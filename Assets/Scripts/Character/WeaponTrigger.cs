...
public class WeaponTrigger : MonoBehaviour
{
    ...
    private AnimController.ATTACK_STANCE m_currentStance = AnimController.ATTACK_STANCE.LIGHT;
    ...
    public void StartManoeuvre(float p_damageStart, float p_damageEnd, AnimController.ATTACK_STANCE p_currentStance)
    {
    ...
    private void DealDamage(float p_animationPercent)
    {
        if(m_damageNextInterval < p_animationPercent)
        {
            ...
            float damage = m_currentStance == AnimController.ATTACK_STANCE.LIGHT ? m_lightDamage / HITMARKER_COUNT : m_heavyDamage / HITMARKER_COUNT;
