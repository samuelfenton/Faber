...
public class CharacterInput_Player : CharacterInput
{
    ...
    public override InputState GetInputState()
    {
        ...
        currentInput.m_lightCombo = m_inputController.GetKeyInput(InputController.INPUT_KEY.ATTACK, InputController.INPUT_STATE.CURRENT);
        currentInput.m_heavyCombo = m_inputController.GetKeyInput(InputController.INPUT_KEY.ATTACK_ALT, InputController.INPUT_STATE.CURRENT);
