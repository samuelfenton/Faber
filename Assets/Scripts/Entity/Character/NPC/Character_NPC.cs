...
public class Character_NPC : Character
{
    ...
    private StateMachine_NPC m_NPCStateMachine = null;

    private StateNPC_Attack m_attackState = null;
    ...
    public override void InitEntity()
    {
        ...
        m_NPCStateMachine = gameObject.AddComponent<StateMachine_NPC>();
        ...
        m_attackState = GetComponent<StateNPC_Attack>();
    }
